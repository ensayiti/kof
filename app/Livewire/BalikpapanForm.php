...
class BalikpapanForm extends Component implements HasForms
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ...
            ->statePath('data')
            ->model(PendaftarBalikpapan::class);
    }
    ...
    public function create(): void
    {
        ...
        $record = PendaftarBalikpapan::create($data);
    ...
    {
        return view('livewire.balikpapan-form');
    }
}
